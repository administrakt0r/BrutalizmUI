...
export type Star6Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star6 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star6 = React.memo(
  React.forwardRef<SVGSVGElement, Star6Props>(
    (
      {
        color,
        size,
