...
export type Star22Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star22 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star22 = React.memo(
  React.forwardRef<SVGSVGElement, Star22Props>(
    (
      {
        color,
        size,
