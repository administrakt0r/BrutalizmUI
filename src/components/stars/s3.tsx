...
export type Star3Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star3 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star3 = React.memo(
  React.forwardRef<SVGSVGElement, Star3Props>(
    (
      {
        color,
        size,
