...
export type Star29Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star29 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star29 = React.memo(
  React.forwardRef<SVGSVGElement, Star29Props>(
    (
      {
        color,
        size,
