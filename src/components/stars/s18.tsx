...
export type Star18Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star18 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star18 = React.memo(
  React.forwardRef<SVGSVGElement, Star18Props>(
    (
      {
        color,
        size,
