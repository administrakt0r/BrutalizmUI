...
export type Star14Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star14 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star14 = React.memo(
  React.forwardRef<SVGSVGElement, Star14Props>(
    (
      {
        color,
        size,
