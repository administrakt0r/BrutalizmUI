...
export type Star26Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star26 component optimized with React.memo and React.forwardRef.
 * @preview ![img](data:image/png;base64,)
 */
const Star26 = React.memo(
  React.forwardRef<SVGSVGElement, Star26Props>(
    (
      {
        color,
        size,
