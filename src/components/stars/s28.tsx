...
export type Star28Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star28 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star28 = React.memo(
  React.forwardRef<SVGSVGElement, Star28Props>(
    (
      {
        color,
        size,
