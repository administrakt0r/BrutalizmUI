...
export type Star39Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star39 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star39 = React.memo(
  React.forwardRef<SVGSVGElement, Star39Props>(
    (
      {
        color,
        size,
...
Star39.displayName = "Star39"

export default Star39
