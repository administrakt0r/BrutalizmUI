...
export type Star37Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star37 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star37 = React.memo(
  React.forwardRef<SVGSVGElement, Star37Props>(
    (
      {
        color,
        size,
