...
export type Star7Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star7 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star7 = React.memo(
  React.forwardRef<SVGSVGElement, Star7Props>(
    (
      {
        color,
        size,
