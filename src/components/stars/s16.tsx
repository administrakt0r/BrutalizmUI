...
export type Star16Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star16 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star16 = React.memo(
  React.forwardRef<SVGSVGElement, Star16Props>(
    (
      {
        color,
        size,
