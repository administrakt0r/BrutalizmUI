...
export type Star8Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star8 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star8 = React.memo(
  React.forwardRef<SVGSVGElement, Star8Props>(
    (
      {
        color,
        size,
