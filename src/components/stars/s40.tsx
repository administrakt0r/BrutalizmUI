...
export type Star40Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star40 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star40 = React.memo(
  React.forwardRef<SVGSVGElement, Star40Props>(
    (
      {
        color,
        size,
