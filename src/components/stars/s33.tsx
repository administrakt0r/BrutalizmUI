...
export type Star33Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star33 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star33 = React.memo(
  React.forwardRef<SVGSVGElement, Star33Props>(
    (
      {
        color,
        size,
