...
export type Star5Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star5 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star5 = React.memo(
  React.forwardRef<SVGSVGElement, Star5Props>(
    (
      {
        color,
        size,
