...
export type Star13Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star13 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star13 = React.memo(
  React.forwardRef<SVGSVGElement, Star13Props>(
    (
      {
        color,
        size,
