...
export type Star27Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star27 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star27 = React.memo(
  React.forwardRef<SVGSVGElement, Star27Props>(
    (
      {
        color,
        size,
