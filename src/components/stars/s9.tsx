...
export type Star9Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star9 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star9 = React.memo(
  React.forwardRef<SVGSVGElement, Star9Props>(
    (
      {
        color,
        size,
