...
export type Star4Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star4 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star4 = React.memo(
  React.forwardRef<SVGSVGElement, Star4Props>(
    (
      {
        color,
        size,
