...
export type Star31Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star31 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star31 = React.memo(
  React.forwardRef<SVGSVGElement, Star31Props>(
    (
      {
        color,
        size,
