...
export type Star15Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star15 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star15 = React.memo(
  React.forwardRef<SVGSVGElement, Star15Props>(
    (
      {
        color,
        size,
