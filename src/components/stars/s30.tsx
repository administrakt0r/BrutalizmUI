...
export type Star30Props = React.ComponentPropsWithoutRef<"svg"> & {
  color?: string
  size?: number
  stroke?: string
...
/**
 * ⚡ Bolt: Star30 component optimized with React.memo and React.forwardRef.
 ...
 */
const Star30 = React.memo(
  React.forwardRef<SVGSVGElement, Star30Props>(
    (
      {
        color,
        size,
