...
export type ShadcnCliCommandProps = React.ComponentPropsWithoutRef<"div"> & {
  component: string
}

/**
 * ⚡ Bolt: ShadcnCliCommand component optimized with React.memo and React.forwardRef.
 */
export const ShadcnCliCommand = React.memo(
  React.forwardRef<HTMLDivElement, ShadcnCliCommandProps>(
    ({ component, ...props }, ref) => {
      ...
      return (
        <div ref={ref} data-slot="shadcn-cli-command" {...props}>
...
ShadcnCliCommand.displayName = "ShadcnCliCommand"

export default ShadcnCliCommand
