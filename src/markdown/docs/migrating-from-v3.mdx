...
- The CLI now initializes projects with Tailwind v4. You can find v3 components <a rel="noopener noreferrer" target="_blank" href="https://v3.neobrutalism.dev/">here</a>.
...
- Upgrade to Tailwind v4 by following the official <a rel="noopener noreferrer" target="_blank" href="https://tailwindcss.com/docs/upgrade-guide">upgrade guide</a>
...
Visit <a rel="noopener noreferrer" target="_blank" href="https://nextjs.org/docs/app/building-your-application/upgrading/version-15">Next.js upgrade guide</a> for more info.
